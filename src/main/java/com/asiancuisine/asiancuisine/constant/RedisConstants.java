...
public class RedisConstants {
    ...
    public static final Long TAGS_COUNT_ONE_USER = 3L;

    public static final String HOT_TAGS_KEY = "hot_tags";

    public static final String USER_PREVIEW_KEY = "user_preview:";
